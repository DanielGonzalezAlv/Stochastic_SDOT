...
% For subsubsection- Levels of sectioning
\setcounter{tocdepth}{4}
%\setcounter{secnumdepth}{4}
% to geth some fonts, e.g mathds 1
\usepackage{dsfont}
...
% For underline overline durchstreichen
\usepackage{ulem}
...
\DeclareMathOperator{\forAll}{ for\ all \ }
...
\newcommand\equal{\mkern1.5mu{=}\mkern1.5mu}
...
\newcommand{\unsure}[1]{\todo[backgroundcolor=blue!25,bordercolor=blue,inline]{#1}}
%\newcommandx{\change}[1]{\todo[linecolor=blue,backgroundcolor=blue!25,bordercolor=blue,inline]{#2}}
